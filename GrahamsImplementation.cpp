...
/*
 * Main function Implementing Grahams Algorithm
 * Input: Set of Points
...
cout<< "Convex Hull Size: "<< count<<" Vertex for region of "
			<< n << " points"<<endl;
}
...
int main()
{
	...
	ifstream infile;
	infile.open("C:\\Users\\Sharath\\Desktop\\graphData1.txt");
	if(!infile.is_open()) {
	...
	cout << "Time Taken for Grahams Algorithm: "<<time2-time1<<endl;
